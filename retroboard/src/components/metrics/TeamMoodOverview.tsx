...
interface TeamMoodOverviewProps {
  ...
  globalTeamMoodCounts: { ottima: number; buona: number; sufficiente: number; scarsa: number }
}

export function TeamMoodOverview({ sessionTeamMoods, globalTeamMoodCounts }: TeamMoodOverviewProps) {
  const pieData = Object.entries(globalTeamMoodCounts)
